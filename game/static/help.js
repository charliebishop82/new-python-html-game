...
(() => {
  ...
  const FIELD_HELP = {
    ...
    class_id: 'Permanent class choice. Classes add base attributes plus a small specialty passive used by combat, exploration, or the economy.',
    ...
    credit_multiplier: 'Fractional bonus to generated credit rewards. It does not multiply credits transferred from another player.',
    steal_bonus: 'Bonus applied to opposed stealing rolls and applicable steal rewards.',
    bonus_ap: 'Additional daily AP supplied while equipped, limited by the global AP cap.',
  ...
  const TEXT_HELP = {
    ...
    'blacksmith': 'Pay AP once to enter, then repair damaged equipment for credits without another AP charge until you leave.',
    'shop': 'Pay AP once to enter, then buy or sell without additional AP costs during the visit.',
    'vendor credits': 'Your personal daily limit on credits the system Shop can pay for direct sales. It resets at midnight UTC and is not shared with other characters.',
    ...
    'equipment': 'Manage your weapon, outfit, and special items. One special slot is available initially; additional slots unlock at Levels 8 and 16.',
    ...
    'crews': 'Browse teams, crew reputations, membership limits, shared pools, and applications.',
    'daily contract': 'One imported objective per UTC day with substantial XP, credit, and AP rewards.',
    'war room': 'Your private archive of enemy encounters, known equipment, results, and earned reputations.',
    'player list': 'Public character names, levels, reputations, PvP victories, and broad activity only.',
    ...
    'steal': 'Use an opposed AGI and LCK roll. PvP success tries an unequipped item first. Boss and minion success makes a separate Luck-and-steal-bonus item roll for an eligible special, weapon, or outfit, with credits otherwise.',
    ...
    'possible damage': 'Normal pre-resistance range: weapon die + relevant STR or AGI modifier + weapon-tier damage (+1 every three weapon levels after level 3, maximum +5) + separate bonus-damage effects.',
    'armor class': 'Attack total required to hit you: 10 plus half effective AGI, authored outfit AC, the outfit level-tier bonus (+0 at Levels 1–3, +1 at 4–9, +2 at 10–15, +3 at 16–18), and active special-item, perk, and temporary AC bonuses.',
    ...
    'tavern healing': 'Percentage of currently missing HP restored. The displayed credit price is calculated per HP restored with a minimum treatment charge.',
