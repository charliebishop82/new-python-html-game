...
TRICKLE_AP_AMOUNT                      = 1
TRICKLE_AP_INTERVAL_HOURS              = 1
TRAVELING_MERCHANT_CHANCE              = 0.05
TRAVELING_MERCHANT_DURATION_HOURS      = 6
TRAVELING_MERCHANT_ITEM_COUNT          = 5
TRAVELING_MERCHANT_MARKUP              = 0.25
...
COMBAT_DEFEAT_XP                       = 10
SUCCESSFUL_ROLL_XP                     = 5
COMBAT_MICRO_XP_CAP                    = 15
PVP_OPPONENT_ESCAPE_XP                 = 10
...
SHOP_WEAPONS_COUNT                     = 5
SHOP_ARMOR_COUNT                       = 5
SHOP_SPECIAL_COUNT                     = 2
SHOP_DISCOUNT_MAX                      = 0.50
SHOP_DAILY_VENDOR_CREDITS              = 2500
SHOP_PLAYER_SOLD_LISTING_CAP            = 30
...
INTERRUPTION_LUCK_DC                   = 15
PROTAGONIST_ENCOUNTER_XP_PER_LEVEL     = 10
PROTAGONIST_ENCOUNTER_CREDITS_BASE     = 15
PROTAGONIST_ENCOUNTER_CREDITS_PER_LEVEL = 10
...
WORLD_BOSS_XP_PER_DAMAGE               = 1.0
WORLD_BOSS_XP_PER_ROUND                = 2.0
WORLD_BOSS_CREDITS_PER_DAMAGE          = 0.25
WORLD_BOSS_CREDITS_PER_ROUND           = 1.0
...
SETTING_TYPES = {
    ...
    "TRAVELING_MERCHANT_DURATION_HOURS": int,
    "TRAVELING_MERCHANT_ITEM_COUNT": int,
    ...
    "SUCCESSFUL_ROLL_XP": int, "COMBAT_MICRO_XP_CAP": int,
    "PVP_OPPONENT_ESCAPE_XP": int,
    ...
    "SHOP_ARMOR_COUNT": int, "SHOP_SPECIAL_COUNT": int,
    "SHOP_DAILY_VENDOR_CREDITS": int,
    "SHOP_PLAYER_SOLD_LISTING_CAP": int,
    ...
    "ENCOUNTER_MAX_LEVEL_ABOVE": int,
    "INTERRUPTION_LUCK_DC": int, "PROTAGONIST_ENCOUNTER_XP_PER_LEVEL": int,
    "PROTAGONIST_ENCOUNTER_CREDITS_BASE": int,
    "PROTAGONIST_ENCOUNTER_CREDITS_PER_LEVEL": int,
    ...
    "TRAVELING_MERCHANT_CHANCE": float, "TRAVELING_MERCHANT_MARKUP": float,
    ...
    "WORLD_BOSS_XP_PER_DAMAGE": float, "WORLD_BOSS_XP_PER_ROUND": float,
    "WORLD_BOSS_CREDITS_PER_DAMAGE": float, "WORLD_BOSS_CREDITS_PER_ROUND": float,
