...
<h2>Create NPC</h2>
<form method="POST" action="/admin/npcs" style="display:grid;grid-template-columns:repeat(4,minmax(150px,1fr));gap:10px;background:#111;padding:12px;border:1px solid #222;">
    ...
    <label>Preset<br><select name="preset"><option value="hunter">Player Hunter</option><option value="boss">Boss Killer</option><option value="hoarder">Hoarder</option><option value="thief">Thief</option><option value="hybrid">Hybrid</option><option value="custom">Custom</option></select></label>
    <label>Player Hunter 0-100<br><input type="number" name="player_hunter" min="0" max="100" value="50"></label>
    <label>Boss Killer 0-100<br><input type="number" name="boss_killer" min="0" max="100" value="50"></label>
    <label>Hoarder 0-100<br><input type="number" name="hoarder" min="0" max="100" value="50"></label>
    <label>Thief 0-100<br><input type="number" name="thief" min="0" max="100" value="0"></label>
    <label>Aggression 0-100<br><input type="number" name="aggression" min="0" max="100" value="50"></label>
    <label>Self-preservation 0-100<br><input type="number" name="self_preservation" min="0" max="100" value="50"></label>
    <label>Repair tendency 0-100<br><input type="number" name="repair_tendency" min="0" max="100" value="60"></label>
